...
export default function App() {
  ...
  // useEffect(
  //   function () {
  //     console.log("You just typed in the search bar");
  //   },
  //   [query]
  // );
  ...
  //making it so that when we click the already selected movie that it closes
    ...
    function () {
      async function fetchMovies() {
        try {
          ...
          // setIsLoading(false); we added this to the 'finally' block that exectues this after everything is done
        } catch (err) {
